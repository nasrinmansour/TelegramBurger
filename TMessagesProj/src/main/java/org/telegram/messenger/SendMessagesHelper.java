...
public class SendMessagesHelper implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void processForwardFromMyName(MessageObject messageObject, long did, boolean asAdmin) {
        ...
        if (messageObject.messageOwner.media != null && !(messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaEmpty) && !(messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaWebPage)) {
            if (messageObject.messageOwner.media.photo instanceof TLRPC.TL_photo) {
                ...
                photo.caption = messageObject.messageOwner.media.caption;
                sendMessage(photo, null, did, messageObject.replyMessageObject, asAdmin, null);
            } else if (messageObject.messageOwner.media.document instanceof TLRPC.TL_document) {
                TLRPC.TL_document document = (TLRPC.TL_document)messageObject.messageOwner.media.document;
                document.caption = messageObject.messageOwner.media.caption;
                sendMessage(document, null, messageObject.messageOwner.attachPath, did, messageObject.replyMessageObject, asAdmin, null);
            ...
            } else {                ArrayList<MessageObject> arrayList = new ArrayList<>();
    ...
    public void removeFromSendingMessages(int mid) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (videoEditedInfo != null || videoPath.endsWith("mp4")) {
                    ...
                    if(videoEditedInfo.caption!=null){
                        document.caption=videoEditedInfo.caption;
                    }
                    ...
                    prepareSendingDocumentInternal(videoPath, videoPath, null, null, dialog_id, reply_to_msg, asAdmin, (videoEditedInfo!=null && videoEditedInfo.caption!=null)?videoEditedInfo.caption:null);
                }
            }
        }).start();
    }

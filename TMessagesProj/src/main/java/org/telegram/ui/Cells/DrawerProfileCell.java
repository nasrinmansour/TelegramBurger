...
public class DrawerProfileCell extends FrameLayout {
    ...
    private void updateColors(){
        setBackgroundColor(AndroidUtilities.getThemeColor());
        phoneTextView.setTextColor(AndroidUtilities.getDarkerThemeColor(-0x40));
        ...
        AvatarDrawable avatarDrawable = new AvatarDrawable(user);
        avatarDrawable.setColor(AndroidUtilities.getDarkerThemeColor(0x15));
        avatarImageView.setImage(photo, "50_50", avatarDrawable);

...
public class DialogCell extends BaseCell {
    ...
    private static Drawable favouriteDrawable;
    private static Drawable sepehrLockDrawable;
    ...
    private boolean dialogIsInFavourite;
    private boolean dialogIsLocked;
    ...
    public DialogCell(Context context) {
        ...
        if (namePaint == null) {
            ...
            namePaint.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getFont1Path()));

            nameEncryptedPaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            nameEncryptedPaint.setTextSize(AndroidUtilities.dp(17));
            nameEncryptedPaint.setColor(0xff00a60e);
            nameEncryptedPaint.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getFont1Path()));
            ...
            countPaint.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getFont1Path()));
            ...
            favouriteDrawable = getResources().getDrawable(R.drawable.fav_icon);
            sepehrLockDrawable = getResources().getDrawable(R.drawable.lock_icon);
        }
        ...
        this.statusBG.setColor(Constant.USER_STATUS_COLOR_OFFLINE);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if(LocaleController.isRTL){
            setDrawableBounds(this.statusBG, getMeasuredWidth() - AndroidUtilities.dp(65.0F) + AndroidUtilities.dp(4.0F), AndroidUtilities.dp(46.0F), AndroidUtilities.dp(16.0F), AndroidUtilities.dp(16.0F));
        }else{
            setDrawableBounds(this.statusBG, AndroidUtilities.dp(13.0f) + AndroidUtilities.dp(36.0F), AndroidUtilities.dp(46.0F), AndroidUtilities.dp(16.0F), AndroidUtilities.dp(16.0F));
        }
    }
...
//        drawStatus = false;
        ...
        CharSequence messageStringFinal = dialogIsLocked?"":TextUtils.ellipsize(messageString, currentMessagePaint, messageWidth - AndroidUtilities.dp(12), TextUtils.TruncateAt.END);
        try {
        ...
        if (LocaleController.isRTL) {
            if (nameLayout != null && nameLayout.getLineCount() > 0) {
                ...
                if(dialogIsInFavourite){
/*                    if(nameMuteLeft>0){*/
                        favouriteLeft = nameMuteLeft - ((dialogMuted || drawVerified)?AndroidUtilities.dp(1):AndroidUtilities.dp(-12)) - favouriteDrawable.getIntrinsicWidth();
/*                    }else{
                        favouriteLeft = (int) (nameLeft + (nameWidth - widthpx) - AndroidUtilities.dp(6) - favouriteDrawable.getIntrinsicWidth());
                    }*/
                }
                if(dialogIsLocked){
                    if(dialogIsInFavourite){
                        lockLeft=favouriteLeft - AndroidUtilities.dp(1) - sepehrLockDrawable.getIntrinsicWidth();
                    }else {
/*                        if (nameMuteLeft > 0) {*/
                            lockLeft = nameMuteLeft - ((dialogMuted || drawVerified)?AndroidUtilities.dp(1):AndroidUtilities.dp(-12)) - favouriteDrawable.getIntrinsicWidth();
/*                        } else {
                            lockLeft = (int) (nameLeft + (nameWidth - widthpx) - AndroidUtilities.dp(6) - sepehrLockDrawable.getIntrinsicWidth());
                        }*/
                    }
                }
                if (left == 0) {
...
//                }
                if(dialogIsInFavourite){
                    favouriteLeft = nameMuteLeft  + ((dialogMuted || drawVerified)?AndroidUtilities.dp(12):0);
                }

                if(dialogIsLocked){
                    if(dialogIsInFavourite){
                        lockLeft=favouriteLeft + AndroidUtilities.dp((nameMuteLeft > 0?14:-6));
                    }else {
/*                        if (nameMuteLeft > 0) {*/
                            lockLeft = nameMuteLeft  + AndroidUtilities.dp(12);
/*                        } else {
                            lockLeft = (int) (nameLeft + left + AndroidUtilities.dp(6));
                        }*/
                    }
                }
            }
    ...
    public void update(int mask) {
        ...
        dialogIsInFavourite = isDialogCell && Favourite.isFavourite(currentDialogId);
        dialogIsLocked = isDialogCell && Lock.isLock(currentDialogId);
        user = null;
        chat = null;
        encryptedChat = null;
    ...
    private void setStatusColor(){
        if (this.user != null && this.drawStatus && !user.bot) {
            String str = LocaleController.formatUserStatus(this.user);
            this.lastStatus = str;
            if (str.equals(LocaleController.getString("ALongTimeAgo", R.string.ALongTimeAgo))) {
                this.statusBG.setColor(Constant.USER_STATUS_COLOR_ALONG_TIME_AGO);
            } else if (str.equals(LocaleController.getString("Online", R.string.Online))) {
                this.statusBG.setColor(Constant.USER_STATUS_COLOR_ONLINE);
            } else if (str.equals(LocaleController.getString("Lately", R.string.Lately))) {
                this.statusBG.setColor(Constant.USER_STATUS_COLOR_LATELY);
            } else {
                this.statusBG.setColor(Constant.USER_STATUS_COLOR_OFFLINE);
            }
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (dialogIsInFavourite) {
            setDrawableBounds(favouriteDrawable, favouriteLeft, AndroidUtilities.dp(16.5f));
            favouriteDrawable.draw(canvas);
        }

        if (dialogIsLocked) {
            setDrawableBounds(sepehrLockDrawable, lockLeft , AndroidUtilities.dp(16.5f));
            sepehrLockDrawable.draw(canvas);
        }

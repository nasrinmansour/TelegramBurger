...
public class UserCell extends FrameLayout {
    ...
    private final ImageView mutualImageView;
    private final ImageView isBotImageView;
    ...
    public UserCell(Context context, int padding, int checkbox, boolean admin) {
        ...
        int gravity = LocaleController.isRTL ? Gravity.LEFT : Gravity.RIGHT;
        ...
        mutualImageView.setImageResource(R.drawable.mutual_contact_icon);
        addView(mutualImageView, LayoutHelper.createFrame(44, 44.0F, gravity, 10f, 8.0F, 10f, 0.0F));

        isBotImageView = new ImageView(context);
        isBotImageView.setScaleType(ImageView.ScaleType.CENTER);
        isBotImageView.setVisibility(GONE);
        isBotImageView.setImageResource(R.drawable.bot_contact_icon);
        addView(isBotImageView, LayoutHelper.createFrame(44, 44.0F, gravity, 10f, 8.0F, 10f, 0.0F));


        if (admin) {
            adminImage = new ImageView(context);
            adminImage.setImageResource(R.drawable.admin_star);
            addView(adminImage, LayoutHelper.createFrame(16, 16, (LocaleController.isRTL ? Gravity.LEFT : Gravity.RIGHT) | Gravity.TOP, LocaleController.isRTL ? 40 : 0, 13.5f, LocaleController.isRTL ? 0 : 40, 0));
        }
    }
    ...
    public void update(int mask) {
        ...
        if(currentUser!=null) {
            ...
            if (currentUser.bot) {
                isBotImageView.setVisibility(VISIBLE);
            } else {
                isBotImageView.setVisibility(GONE);
            }

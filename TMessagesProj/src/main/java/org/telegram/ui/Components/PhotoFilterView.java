...
public class PhotoFilterView extends FrameLayout {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation) {
        ...
        cancelTextView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getFont1Path()));
        ...
        doneTextView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getFont1Path()));
        ...
        for (int a = 0; a < 4; a++) {
            ...
            curveTextView[a].setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getFont1Path()));
        ...
        tintShadowsButton.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getFont1Path()));
        ...
        tintHighlightsButton.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getFont1Path()));

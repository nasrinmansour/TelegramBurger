...
public class SizeNotifierFrameLayoutPhoto extends FrameLayout {
    ...
    public SizeNotifierFrameLayoutPhoto(Context context, AttributeSet attributeSet){
        super(context,attributeSet);
    }
    public SizeNotifierFrameLayoutPhoto(Context context, AttributeSet attributeSet,int styleAttr){

...
package org.telegram.ui.Components.color_picker;
...
public class ColorPickerDialog
    ...
    private void setUp(int color) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            mColorPicker.setLayerType(View.LAYER_TYPE_SOFTWARE, null);// for shader issue in android 4+
        }
        ...
        ((LinearLayout) mOldColor.getParent().getParent()).setPadding(

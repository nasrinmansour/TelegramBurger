...
public class ResourceLoader {
    ...
    public static Drawable[][] shareDirectDrawable = new Drawable[2][2];
    ...
    public static void loadRecources(Context context) {
        if (backgroundDrawableIn == null) {
            ...
            shareDirectDrawable[0][0] = context.getResources().getDrawable(R.drawable.share_direct_blue);
            shareDirectDrawable[0][1] = context.getResources().getDrawable(R.drawable.share_direct_blue_pressed);
            shareDirectDrawable[1][0] = context.getResources().getDrawable(R.drawable.share_direct_black);
            shareDirectDrawable[1][1] = context.getResources().getDrawable(R.drawable.share_direct_black_pressed);

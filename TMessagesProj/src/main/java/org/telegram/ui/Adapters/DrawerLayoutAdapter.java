...
public class DrawerLayoutAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return UserConfig.isClientActivated() ? ((SepehrSettingsHelper.getIsPremiumSetting())?11:12) : 0;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (type == 0) {
            ...
            if (i == 2) {
                ...
                actionCell.setTextAndIcon(LocaleController.getString("SepehrSettings", R.string.sepehr_settings), R.drawable.menu_settings);
            }  else if (i == 10 || i==11) {
                if(SepehrSettingsHelper.getIsPremiumSetting() || i==11){
                    actionCell.setTextAndIcon(LocaleController.getString("TelegramFaq", R.string.TelegramFaq), R.drawable.menu_help);
                }else {
                    actionCell.setTextAndIcon(LocaleController.getString("UpdateToPremium", R.string.UpdateToPremium), R.drawable.menu_premium);
                }
            }
        }
